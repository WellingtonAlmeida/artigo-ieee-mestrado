...
\author{\uppercase{Wellington G. Almeida}\authorrefmark{1,2}}

\address[1]{Graduate Program in Informatics (PPGI), Federal University of Technology -- Paraná (UTFPR), Cornélio Procópio, PR 86300-000, Brazil (e-mail: walmeida@alunos.utfpr.edu.br)}
\address[2]{Regional Labor Court of the 3rd Region (TRT-MG), Belo Horizonte, MG 30170-910, Brazil}
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{author1.png}}]{Wellington G. Almeida} 
